    ...
    return (
        <div className="min-h-screen p-4 md:p-8 animate-fade-in pb-48 md:pb-8 overflow-x-hidden selection:bg-primary selection:text-black">
            ...
            <header ref={overviewRef} className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 md:mb-10 gap-4">
                <div>
                    ...
                    <div className="flex items-center gap-2 mt-2">
                        <span className="bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-300 px-3 py-1 rounded-full text-xs font-extrabold border border-zinc-200 dark:border-zinc-700">
                            Beta v2.1
                        </span>
                ...
                <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <button
                        ...
                        className="hidden md:flex items-center gap-2 bg-zinc-900 dark:bg-white hover:bg-zinc-800 dark:hover:bg-zinc-200 text-primary dark:text-zinc-900 border-2 border-transparent px-6 py-3 rounded-full transition-all text-sm font-black shadow-lg hover:shadow-xl hover:-translate-y-1"
                    >
            ...
            <div ref={portfolioRef} className="flex flex-row items-center justify-between mb-6 gap-4 mt-8 md:mt-16">
                <h2 className="text-2xl md:text-4xl font-black text-zinc-900 dark:text-white tracking-tighter leading-none">
                    Danh Mục Đầu Tư
                </h2>
                {/* Ghost Button: Icon only on Mobile, Full on Desktop */}
                <button
                    onClick={() => setIsTransModalOpen(true)}
                    className="group bg-transparent hover:bg-zinc-100 dark:hover:bg-white/10 text-zinc-900 dark:text-white border-2 border-zinc-900 dark:border-white rounded-full transition-all flex items-center justify-center gap-2 font-black tracking-wide hover:-translate-y-1 w-10 h-10 md:w-auto md:h-auto md:px-6 md:py-3"
                >
            ...
            <div className="space-y-8">
                                        ...
                                        return (
                                            <div key={idx} className="flex items-center justify-between text-xs">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-zinc-500 dark:text-zinc-400 font-bold tracking-wide">{item.name}</span>
                                                </div>
                ...
                <div>
                    ...
                    <div className="flex items-center justify-between mb-5 px-1">
                        <span className="text-lg font-black text-zinc-900 dark:text-white tracking-tight flex items-center gap-2">
                    ...
                    >
                        ...
                        {stockAssets.length === 0 && (
                            <div className="min-w-[280px] h-[280px] snap-center flex flex-col gap-3 items-center justify-center border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-3xl bg-zinc-50/50 dark:bg-zinc-900/50 text-zinc-400 dark:text-zinc-500 group hover:border-zinc-400 dark:hover:border-zinc-600 transition-colors">
                                <ServerOff size={28} />
                                <span className="text-sm font-extrabold tracking-wide">Chưa có cổ phiếu</span>
                            </div>
                        )}
