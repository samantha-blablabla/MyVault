...
export const StockCard: React.FC<StockCardProps> = ({ stock }) => {
    ...
    return (
        <GlassCard className="h-full group relative overflow-hidden">
            ...
            <div className="absolute inset-x-0 bottom-0 top-1/4 z-0 opacity-50 group-hover:opacity-100 transition-opacity pointer-events-none mask-chart">
            ...
            <div className="relative z-10 flex flex-col h-full">
                <div className="flex justify-between items-start mb-4 shrink-0">
                    <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-2">
                            ...
                            <span className={`text-xs px-1.5 py-0.5 rounded-md font-black border ${isProfit
                        ...
                        <span className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 truncate max-w-[140px] tracking-wide">{stock.name}</span>
                    </div>
                ...
                {stock.targetQuantity && (
                    <div className="space-y-1.5 shrink-0">
                        <div className="flex justify-between text-[10px] text-zinc-500 dark:text-zinc-400 tracking-wider font-bold">
