...
export const NetWorthCard: React.FC = () => {
  ...
  return (
    <GlassCard className="h-full relative overflow-hidden bg-gradient-to-br from-zinc-900/80 to-black/50">
      {/* Background Decor - Monotone */}
      <div className="absolute -top-10 -right-10 w-40 h-40 bg-zinc-700/10 rounded-full blur-3xl"></div>
      ...
      <div className="flex flex-col h-full justify-between gap-4">
        ...
        <div className="flex justify-between items-start">
            <div>
                <h2 className="text-zinc-400 text-xs font-bold uppercase tracking-widest flex items-center gap-2">
                    <Landmark size={14} className="text-zinc-300"/> Tổng Tài Sản Thực Tế
                </h2>
                <div className="mt-2 flex items-end gap-3">
                    ...
                    <div className={`px-2 py-1 rounded text-xs font-bold mb-1.5 flex items-center gap-1 ${totalPnL >= 0 ? 'bg-emerald-500/10 text-emerald-400' : 'bg-rose-500/10 text-rose-400'}`}>
        ...
        <div className="w-full h-3 bg-zinc-800 rounded-full overflow-hidden flex">
            <div className="h-full bg-zinc-200" style={{ width: `${stockPercent}%` }}></div>
            <div className="h-full bg-zinc-600" style={{ width: `${cashPercent}%` }}></div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
            ...
            <div className="p-3 rounded-xl bg-zinc-900/50 border border-white/5 hover:bg-white/5 transition-colors group">
                ...
                <div className="text-lg font-bold text-white group-hover:text-zinc-400 transition-colors">
