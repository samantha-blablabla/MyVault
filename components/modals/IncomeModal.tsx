...
import { X, Check, Wallet, PieChart, AlertCircle, Save } from 'lucide-react';
            ...
            <div className="w-full max-w-sm bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-2xl overflow-hidden animate-slide-up transition-colors">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <button
                        type="submit"
                        disabled={!isValid}
                        className={`w-full mt-2 font-bold py-3 rounded-lg flex items-center justify-center gap-2 transition-all ${isValid
