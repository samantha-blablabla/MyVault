...
export const DailySpendableWidget: React.FC = () => {
  ...
  const TitleComponent = (
      <div className={`flex items-center gap-2 ${isOverBudget ? 'text-rose-500' : 'text-zinc-900 dark:text-white'}`}>
          <div className={`p-1.5 rounded-md border border-black dark:border-transparent flex items-center justify-center ${
              isOverBudget 
    ...
    >
      <div className="flex flex-col h-full gap-4">
        ...
        <div className="flex-1 min-h-0 flex flex-col border-t border-zinc-200 dark:border-zinc-800 pt-3">
            <div className="flex-none text-[10px] font-bold text-zinc-400 uppercase tracking-wider mb-2 flex justify-between items-center">
